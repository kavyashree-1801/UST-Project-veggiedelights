...
body { 
    ...
    background: url('https://thumbs.dreamstime.com/b/staple-foods-recipe-book-space-text-fruit-fish-bread-vegetables-blank-pages-53668614.jpg') no-repeat center center/cover; 
    position: relative;
    color: #333;
}
...
/* Navbar */
.navbar { display:flex; justify-content:space-between; align-items:center; background:#ff7b00; padding:12px 30px; flex-wrap:wrap; z-index:1; position: relative; }
...
.navbar nav a:hover, .navbar nav a.active { background:#fff; color:#ff7b00; }

.auth-links { display:flex; align-items:center; gap:10px; flex-wrap:wrap; }
.auth-links .welcome { color:#fff; font-weight:bold; }
.profile-icon { display:inline-flex; align-items:center; justify-content:center; width:38px; height:38px; background:#fff; color:#ff7b00; border-radius:50%; font-size:20px; font-weight:bold; text-decoration:none; transition:0.3s; }
...
/* Page content */
.recipe-page h1 { text-align:center; color:#ff7b00; margin:20px 0; z-index:1; position: relative; }
.recipe-container { display:flex; flex-wrap:wrap; justify-content:center; gap:20px; padding:20px; z-index:1; position: relative; }
